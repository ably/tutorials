...
4. For tutorials we have used `io.ably.tutorial.push_tutorial_one` and `io.ably.tutorial.push_tutorial_two` as applicationId for the apps respectively. So ensure your FCM Keys have same applicationId. Feel free to modify the tutorials to suit your purpose.
