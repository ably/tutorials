...
This current branch shows a quick demo of idempotent publishing with Ably. With client libraries version 1.2 or up, idempotency is enabled by default for all REST publishes.