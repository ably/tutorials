...
import io.ably.example.androidpushexample.server.NetResponse;
import io.ably.example.androidpushexample.server.ServerAPI;
...
public class MainActivity extends AppCompatActivity {
    ...
    public static final String STEP_3 = "Send Test Push";
    ...
    private static final String LOCAL_SERVER_AUTH_URL = BuildConfig.ABLY_URL + "/auth";
    ...
    private void initAblyPush() throws AblyException {
        String registrationToken = ablyRealtime.push.getLocalDevice().deviceIdentityToken;
        String deviceId = ablyRealtime.push.getLocalDevice().id;
        String clientId = ablyRealtime.push.getLocalDevice().clientId;
